...
from theodore.core.utils import Downloads, user_error, user_info, DB_tasks
...
async def send_command(cmd, file_args: Iterable) -> str:
    ...
    return f"{cmd} is being processed."
...
@click.argument('--url', '-u', type=str, help='comma separated urls')
@click.pass_context
async def file(ctx: click.Context, url: str) -> None:
    """Download, Manage and track downloads"""
